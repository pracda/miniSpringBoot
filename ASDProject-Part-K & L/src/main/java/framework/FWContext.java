...
public class FWContext {
            ...
            for (Object theClass : serviceObjectMap) {
                ...
                for (Method method : clazz.getDeclaredMethods()) {
                        if (method.isAnnotationPresent(Async.class)) {
                            executeAsync(method, theClass, new Object[] {});
                        }
                }
    ...
    private static Object convertValueToFieldType(Class<?> fieldType, String value) {
    ...
    public void executeAsync(Method method, Object bean, Object[] args) {
        executor.execute(() -> {
            try {
    ...
    public void process(ConfigurationProperties annotation, Object bean) {
        ...
        for (Field field : bean.getClass().getDeclaredFields()) {
            ...
            if (value != null) {
                field.setAccessible(true);
                try {
                    field.set(bean, convertValueToFieldType(field.getType(), value));
